...
diff -wpruN --no-dereference '--exclude=*.orig' a~/src/hotspot/os_cpu/solaris_x86/atomic_solaris_x86.hpp a/src/hotspot/os_cpu/solaris_x86/atomic_solaris_x86.hpp
